...
const Quiz = () => {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="w-full sm:w-11/12 md:w-3/4 lg:w-2/3 xl:w-1/2 border shadow-lg rounded-md overflow-hidden bg-white">
        <Box current={current} handler={setCurrent} shuffledQuestions={shuffledQuestions} />
      </div>
    </div>
  );
};
